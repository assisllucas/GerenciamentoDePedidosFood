...
INSERT INTO `flyway_schema_history` VALUES (1,'1','<< Flyway Baseline >>','BASELINE','<< Flyway Baseline >>',NULL,'root','2024-05-08 23:04:26',0,1);
...
INSERT INTO `usuario` VALUES (1,'12345678910','adm','123456','adm@adm.com',NULL);
...
CREATE TABLE `usuario_permissao` (
  ...
  CONSTRAINT `fk_usuario_permissao` FOREIGN KEY (`usuario_id_usuario`) REFERENCES `usuario` (`idusuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-05-08 21:21:58
